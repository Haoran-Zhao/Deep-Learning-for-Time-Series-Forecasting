...
def split_train_test(X, y, well_code, ratio):
    y = y.reshape(-1, 1)
...
def data_prepare(dataframe, ratio):
    ...
    X_train0, X_test0, y_train0, y_test0 = split_train_test(X0, y0, well_code0, ratio)
    X_train1, X_test1, y_train1, y_test1 = split_train_test(X1, y1, well_code1, ratio)
    X_train2, X_test2, y_train2, y_test2 = split_train_test(X2, y2, well_code2, ratio)
    X_train3, X_test3, y_train3, y_test3 = split_train_test(X3, y3, well_code3, ratio)
    X_train4, X_test4, y_train4, y_test4 = split_train_test(X4, y4, well_code4, ratio)
...
model = lstm_model('lstm_ALL10_EACH', train=False)
...
# test on 1C
test_model('NO 15/9-F-1 C', mean_all, std_all)

# test on 11H
test_model('NO 15/9-F-11 H', mean_all, std_all)

# test on 12H
test_model('NO 15/9-F-12 H', mean_all, std_all)

# test on 14H
test_model('NO 15/9-F-14 H', mean_all, std_all)
