...
X_train, X_test, y_train, y_test, mean_all, std_all = data_prepare(df, ['NO 15/9-F-11 H', 'NO 15/9-F-15 D'], ['NO 15/9-F-1 C'])

n_features = X_train.shape[2]
model = lstm_model('lstm_11H_15D_1C', train=False)
