...
X_train = concatenate((X_1C_train, X_11H_train, X_15D_train), axis=0)
y_train = concatenate((y_1C_train, y_11H_train, y_15D_train), axis=0)

X_test = concatenate((X_1C_test, X_11H_test, X_15D_test), axis=0)
y_test = concatenate((y_1C_test, y_11H_test, y_15D_test), axis=0)
...
for i in range(1, 11):
    ...
    model = lstm_model('lstm_1C_11H_15D_EACH', train=True)
